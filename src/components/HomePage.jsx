...
export default function HomePage(props) {
  ...
  return (
    <main className="flex-1 p-4 flex flex-col gap-3 pb-22 text-center sm:gap-4 md:gap-5 justify-center">
        ...
        <button onClick={recordingStatus === 'recording' ? stopRecording : startRecording} className='flex items-center text-base justify-between  rounded-xl gap-4 mx-auto w-72 max-w-full my-4 specialBtn px-4 py-2'>
        ...
        <p className='text-base'>Or <label className='text-blue-400 cursor-pointer hover:text-blue-600 duration-200'>upload 
            <input onChange={(e) => { const tempFile = e.target.files[0]; setFile(tempFile)}} 
